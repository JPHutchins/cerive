...
__attribute__((nonnull(1, 2))) static inline enum cerive_ordering Point_cmp(
	Point const * const a,
	Point const * const b
) {
	{
...
__attribute__((nonnull(1))) static inline size_t Point_hash(Point const * const self) {
...
__attribute__((nonnull(1, 2))) static inline enum cerive_ordering Line_cmp(
	Line const * const a,
	Line const * const b
) {
	{
...
__attribute__((nonnull(1))) static inline size_t Line_hash(Line const * const self) {
	size_t h = cerive_hash_offset;
...
__attribute__((nonnull(1, 2))) static inline enum cerive_ordering Frame_cmp(
	Frame const * const a,
	Frame const * const b
) {
	{
...
__attribute__((nonnull(1))) static inline size_t Frame_hash(Frame const * const self) {
	size_t h = cerive_hash_offset;
...
__attribute__((nonnull(1, 2))) static inline enum cerive_ordering Span_cmp(
	Span const * const a,
	Span const * const b
) {
	{
...
__attribute__((nonnull(1))) static inline size_t Span_hash(Span const * const self) {
	size_t h = cerive_hash_offset;
...
__attribute__((nonnull(1, 2))) static inline enum cerive_ordering Boxed_cmp(
	Boxed const * const a,
	Boxed const * const b
) {
	{
...
__attribute__((nonnull(1))) static inline size_t Boxed_hash(Boxed const * const self) {
	size_t h = cerive_hash_offset;
